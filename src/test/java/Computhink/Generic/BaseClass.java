...
public class BaseClass {
	...
	public static void RoomSelectionCVS() throws Exception {
		...
		sel.selectByValue(ExcelLogin(1, 2)); /// Here You can change Room selection option from Excel change Room name
	...
	public static void LogDipakUser() throws Exception {
		...
		Reporter.log("Scenario 01: Log into a EWA");
		...
		try {
			WebElement sessiomsg = driver.findElement(By.xpath("//*[@id=\"cvModelLoginValidationMessageMulti\"]"));
			WebElement sessiomsgOK = driver.findElement(By.xpath("//button[@id='cvModelLoginValidationOkMulti']"));
			if (sessiomsg.isDisplayed()) {
				Reporter.log("Session is already active in same browser. \r\n"
						+ " Do you want to create new session?Dialog box displayed. User clicks OK button.");
				as.assertEquals(sessiomsgOK.isDisplayed(), "Session dialog's OK button is not displayed.");
				jsclick(sessiomsgOK); // Click the OK button
			}
		} catch (NoSuchElementException e) {
	...
	public static void loginRNISHA47() throws Exception {
		...
		String username = readFromExLogin(1, 0);// readFromExLogin(2, 0) 1,dipak 2.rnisha 5.subham 6.robert
	...
	public static void LogInAdmin() throws Exception {
		...
		String username = readFromExLogin(3, 0); // readFromExLogin(2, 0)//admin Assuming this method reads the username
	...
	public static void snap(String name) throws IOException {
		...
		File Source = new File("C:\\Users\\dipak.p\\eclipse-workspace\\CVS_Auto_2024_B2_64Bit\\DefectFunctionalitySnaps"
				+ name + ".png");
