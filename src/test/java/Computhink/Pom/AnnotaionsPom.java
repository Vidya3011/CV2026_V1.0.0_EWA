...
public class AnnotaionsPom extends BaseClass {
	...
	@FindBy(xpath = ("//*[@id=\"viewDocumentnavigator\"]/ul/li[1]/ul/li[1]/a"))
	private WebElement Drawer;

	@FindBy(xpath = ("//*[@id=\"viewDocumentnavigator\"]/ul/li[1]/ul/li[1]/ul/li[1]/a"))
	...
	public void signatureAnnotation() throws Exception {
		...
		try {
			...
			act.click(SignPasswordDialog).sendKeys("vw").build().perform();
			Thread.sleep(5000);
